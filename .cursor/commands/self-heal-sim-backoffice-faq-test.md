...
**Read the expected behavior from:** `test-behaviors/sim-backoffice-faq-test.md`
...
1. Read the behavior steps from `test-behaviors/sim-backoffice-faq-test.md`
...
- Read the behavior steps from `test-behaviors/sim-backoffice-faq-test.md` (the single source of truth)
